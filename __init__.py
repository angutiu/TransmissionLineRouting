...
def classFactory(iface):  # pylint: disable=invalid-name
    """Load TransmissionLineRouting class from file TransmissionLineRouting.

    :param iface: A QGIS interface instance.
    :type iface: QgsInterface
    """
    #
    from .transmission_line_routing import TransmissionLineRoutingPlugin
    return TransmissionLineRoutingPlugin()
